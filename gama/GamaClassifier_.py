# -*- coding: utf-8 -*-
"""
Created on Mon Nov 29 22:14:02 2021
...
class GamaClassifier(Gama):
    ...
    def __init__(self, config=None, scoring="neg_log_loss", time_support = 3600, *args, **kwargs):
        if not config:
...
#                os.remove(path)
            ...
            setattr(
                ...
                partialmethod(
                    Gama.__init__,
                    max_total_time = int(self._time_support/len(list(rungs))),
                ),
            )
            print("self._time_support GamaClassifier", self._time_support)
#            path_use = os.getcwd()
#            path = path_use.replace(os.sep, '/')
#            path = path + "/" + "dictionary_info.pkl"
            ...
            for m in rungs:
                ...
                if r_m > maximum_resource:
                    percentage_row = 1 
                     ...
                     percentage_row = 1-(r_m*100/maximum_resource/100) # These what I was used until 29-11-2021 because the second /100 is for train_test_split
