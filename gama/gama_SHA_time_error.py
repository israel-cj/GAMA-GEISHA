# -*- coding: utf-8 -*-
"""
Created on Tue Nov  9 21:25:05 2021
...
#        print("max_eval_time NSHA", max_total_time)
#        if max_total_time is not None:
#            max_total_time = int(max_total_time/9)
...
#        
#        print("max_eval_time", self._max_total_time_support)
#        print("sha[time]", sha["time"])
#        self._max_total_time_support = int(self._max_total_time_support/sha["time"])
#        print("max_eval_time", self._max_total_time_support)
        ...
        path=path + "/" + "dictionary_info.pkl"
        sha = pickle.load(open(path, "rb"))
        print("max_total_time", self._max_total_time_support)
        max_total_time= int(self._max_total_time_support/sha["time"])
        print("max_total_time", max_total_time)
        max_eval_time = self._max_eval_time_support
